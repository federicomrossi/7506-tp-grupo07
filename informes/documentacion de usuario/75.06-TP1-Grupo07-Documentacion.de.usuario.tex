...
\itemsep=5pt \topsep=0pt \partopsep=0pt \parskip=0pt \parsep=0pt
	...
	\item \textit{ESTADISTA\_MAXIMO\_}: Son tres parametros que indican la cantidad máxima de resultados en las estadísticas.

	\item \textit{PPMC\_ORDER}: Orden máximo para el algoritmo de compresión.
