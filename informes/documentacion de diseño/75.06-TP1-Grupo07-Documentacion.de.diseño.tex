...
\subsection{Módulo de estadísticas}
	...
	\par
	Las estadísticas pueden ser consultadas en cualquier momento, lo cual permitirá ver el estado de lo computado y procesado hasta el momento. Se permite especificar en estos la cantidad 
